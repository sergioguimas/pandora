...
-- Started on 2026-07-16 16:50:25
...
--
-- TOC entry 619 (class 1255 OID 41751)
-- Name: can_read_org(uuid, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.can_read_org(p_organization_id uuid, p_user_id uuid) RETURNS boolean
...
ALTER FUNCTION public.can_read_org(p_organization_id uuid, p_user_id uuid) OWNER TO postgres;
...
--
-- TOC entry 613 (class 1255 OID 18650)
...
--
-- TOC entry 611 (class 1255 OID 18302)
...
--
-- TOC entry 610 (class 1255 OID 18301)
...
--
-- TOC entry 609 (class 1255 OID 18300)
...
--
-- TOC entry 618 (class 1255 OID 41750)
-- Name: is_system_org(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.is_system_org(p_organization_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  select exists (
...
ALTER FUNCTION public.is_system_org(p_organization_id uuid) OWNER TO postgres;

--
-- TOC entry 620 (class 1255 OID 41795)
...
--
-- TOC entry 608 (class 1255 OID 18137)
...
CREATE TABLE public.agents (
    ...
    modo_resposta text DEFAULT 'medio'::text NOT NULL,
    CONSTRAINT agents_max_history_messages_check CHECK (((max_history_messages >= 1) AND (max_history_messages <= 100))),
    CONSTRAINT agents_modo_resposta_check CHECK ((modo_resposta = ANY (ARRAY['leve'::text, 'medio'::text, 'alto'::text]))),
...
--
-- TOC entry 4037 (class 2606 OID 17637)
...
--
-- TOC entry 4016 (class 2606 OID 17577)
...
--
-- TOC entry 4070 (class 2606 OID 18464)
...
--
-- TOC entry 4064 (class 2606 OID 18230)
...
--
-- TOC entry 4066 (class 2606 OID 18228)
...
--
-- TOC entry 4023 (class 2606 OID 17589)
...
--
-- TOC entry 4053 (class 2606 OID 18091)
...
--
-- TOC entry 4045 (class 2606 OID 18077)
...
--
-- TOC entry 4078 (class 2606 OID 18497)
...
--
-- TOC entry 4035 (class 2606 OID 17623)
...
--
-- TOC entry 4032 (class 2606 OID 17609)
...
--
-- TOC entry 4060 (class 2606 OID 18199)
...
--
-- TOC entry 4062 (class 2606 OID 18197)
...
--
-- TOC entry 4056 (class 2606 OID 18186)
...
--
-- TOC entry 4014 (class 2606 OID 17562)
...
--
-- TOC entry 4038 (class 1259 OID 17647)
...
--
-- TOC entry 4017 (class 1259 OID 18510)
...
--
-- TOC entry 4018 (class 1259 OID 18509)
...
--
-- TOC entry 4019 (class 1259 OID 41757)
...
--
-- TOC entry 4020 (class 1259 OID 18511)
...
--
-- TOC entry 4071 (class 1259 OID 18560)
...
--
-- TOC entry 4072 (class 1259 OID 18559)
...
--
-- TOC entry 4073 (class 1259 OID 18487)
...
--
-- TOC entry 4074 (class 1259 OID 18475)
...
--
-- TOC entry 4067 (class 1259 OID 18241)
...
--
-- TOC entry 4068 (class 1259 OID 18242)
...
--
-- TOC entry 4024 (class 1259 OID 17644)
...
--
-- TOC entry 4025 (class 1259 OID 18135)
...
--
-- TOC entry 4026 (class 1259 OID 18217)
...
--
-- TOC entry 4027 (class 1259 OID 17643)
...
--
-- TOC entry 4028 (class 1259 OID 18136)
...
--
-- TOC entry 4046 (class 1259 OID 18103)
...
--
-- TOC entry 4047 (class 1259 OID 18133)
...
--
-- TOC entry 4048 (class 1259 OID 18105)
...
--
-- TOC entry 4049 (class 1259 OID 41778)
-- Name: idx_knowledge_chunks_organization_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_knowledge_chunks_organization_id ON public.knowledge_chunks USING btree (organization_id);


--
-- TOC entry 4050 (class 1259 OID 18134)
...
--
-- TOC entry 4051 (class 1259 OID 18523)
...
--
-- TOC entry 4039 (class 1259 OID 18102)
...
--
-- TOC entry 4040 (class 1259 OID 18131)
...
--
-- TOC entry 4041 (class 1259 OID 41777)
-- Name: idx_knowledge_documents_organization_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4042 (class 1259 OID 18132)
...
--
-- TOC entry 4043 (class 1259 OID 18522)
...
--
-- TOC entry 4075 (class 1259 OID 18498)
...
--
-- TOC entry 4076 (class 1259 OID 41765)
-- Name: idx_knowledge_spaces_organization_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_knowledge_spaces_organization_id ON public.knowledge_spaces USING btree (organization_id);


--
-- TOC entry 4033 (class 1259 OID 17646)
...
--
-- TOC entry 4029 (class 1259 OID 17645)
...
--
-- TOC entry 4030 (class 1259 OID 18447)
...
--
-- TOC entry 4057 (class 1259 OID 18215)
...
--
-- TOC entry 4058 (class 1259 OID 18216)
...
--
-- TOC entry 4021 (class 1259 OID 41758)
-- Name: uq_agents_org_slug; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX uq_agents_org_slug ON public.agents USING btree (organization_id, slug);


--
-- TOC entry 4054 (class 1259 OID 18104)
...
--
-- TOC entry 4079 (class 1259 OID 41766)
-- Name: uq_knowledge_spaces_default_per_org; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX uq_knowledge_spaces_default_per_org ON public.knowledge_spaces USING btree (organization_id) WHERE is_default;


--
-- TOC entry 4106 (class 2620 OID 17701)
...
--
-- TOC entry 4107 (class 2620 OID 17661)
...
--
-- TOC entry 4109 (class 2620 OID 18138)
...
--
-- TOC entry 4108 (class 2620 OID 17663)
...
--
-- TOC entry 4089 (class 2606 OID 17638)
...
--
-- TOC entry 4081 (class 2606 OID 18503)
...
--
-- TOC entry 4082 (class 2606 OID 41752)
...
--
-- TOC entry 4103 (class 2606 OID 18470)
...
--
-- TOC entry 4104 (class 2606 OID 18465)
...
--
-- TOC entry 4101 (class 2606 OID 18231)
...
--
-- TOC entry 4102 (class 2606 OID 18236)
...
--
-- TOC entry 4083 (class 2606 OID 17595)
...
--
-- TOC entry 4084 (class 2606 OID 18210)
...
--
-- TOC entry 4085 (class 2606 OID 17590)
...
--
-- TOC entry 4094 (class 2606 OID 18097)
...
--
-- TOC entry 4095 (class 2606 OID 18123)
...
--
-- TOC entry 4096 (class 2606 OID 18092)
...
--
-- TOC entry 4097 (class 2606 OID 18517)
...
--
-- TOC entry 4098 (class 2606 OID 41772)
-- Name: knowledge_chunks knowledge_chunks_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4090 (class 2606 OID 18078)
...
--
-- TOC entry 4092 (class 2606 OID 18512)
...
--
-- TOC entry 4093 (class 2606 OID 41767)
-- Name: knowledge_documents knowledge_documents_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4105 (class 2606 OID 41760)
-- Name: knowledge_spaces knowledge_spaces_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.knowledge_spaces
    ADD CONSTRAINT knowledge_spaces_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id) ON DELETE CASCADE;


--
-- TOC entry 4088 (class 2606 OID 17624)
...
--
-- TOC entry 4086 (class 2606 OID 17610)
...
--
-- TOC entry 4087 (class 2606 OID 18442)
...
--
-- TOC entry 4099 (class 2606 OID 18200)
...
--
-- TOC entry 4100 (class 2606 OID 18205)
...
--
-- TOC entry 4080 (class 2606 OID 17563)
...
--
-- TOC entry 4280 (class 3256 OID 18252)
...
--
-- TOC entry 4291 (class 3256 OID 18477)
...
--
-- TOC entry 4284 (class 3256 OID 18306)
...
--
-- TOC entry 4285 (class 3256 OID 18334)
...
--
-- TOC entry 4292 (class 3256 OID 18478)
...
--
-- TOC entry 4293 (class 3256 OID 18479)
...
--
-- TOC entry 4287 (class 3256 OID 18453)
...
--
-- TOC entry 4288 (class 3256 OID 18454)
...
--
-- TOC entry 4281 (class 3256 OID 18308)
...
--
-- TOC entry 4290 (class 3256 OID 18476)
...
--
-- TOC entry 4289 (class 3256 OID 18456)
...
--
-- TOC entry 4294 (class 3256 OID 18481)
...
--
-- TOC entry 4282 (class 3256 OID 18303)
...
--
-- TOC entry 4286 (class 3256 OID 18345)
...
--
-- TOC entry 4283 (class 3256 OID 18304)
...
--
-- TOC entry 4279 (class 3256 OID 18243)
...
--
-- TOC entry 4263 (class 0 OID 17629)
-- Dependencies: 370
...
--
-- TOC entry 4311 (class 3256 OID 41796)
-- Name: agent_knowledge_files agent_knowledge_files_select_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY agent_knowledge_files_select_org ON public.agent_knowledge_files FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.agents a
  WHERE ((a.id = agent_knowledge_files.agent_id) AND public.can_read_org(a.organization_id, auth.uid())))));


--
-- TOC entry 4259 (class 0 OID 17568)
-- Dependencies: 366
...
--
-- TOC entry 4298 (class 3256 OID 41782)
-- Name: agents agents_delete_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY agents_delete_org ON public.agents FOR DELETE TO authenticated USING (public.is_org_member(organization_id, auth.uid()));


--
-- TOC entry 4296 (class 3256 OID 41780)
-- Name: agents agents_insert_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY agents_insert_org ON public.agents FOR INSERT TO authenticated WITH CHECK (public.is_org_member(organization_id, auth.uid()));


--
-- TOC entry 4295 (class 3256 OID 41779)
-- Name: agents agents_select_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY agents_select_org ON public.agents FOR SELECT TO authenticated USING (public.can_read_org(organization_id, auth.uid()));


--
-- TOC entry 4297 (class 3256 OID 41781)
-- Name: agents agents_update_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY agents_update_org ON public.agents FOR UPDATE TO authenticated USING (public.is_org_member(organization_id, auth.uid())) WITH CHECK (public.is_org_member(organization_id, auth.uid()));


--
-- TOC entry 4269 (class 0 OID 18458)
-- Dependencies: 376
...
--
-- TOC entry 4268 (class 0 OID 18218)
-- Dependencies: 375
...
--
-- TOC entry 4260 (class 0 OID 17580)
-- Dependencies: 367
...
--
-- TOC entry 4275 (class 3256 OID 17654)
...
--
-- TOC entry 4274 (class 3256 OID 17653)
...
--
-- TOC entry 4276 (class 3256 OID 17655)
...
--
-- TOC entry 4265 (class 0 OID 18083)
-- Dependencies: 372
...
--
-- TOC entry 4310 (class 3256 OID 41794)
-- Name: knowledge_chunks knowledge_chunks_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_chunks_delete ON public.knowledge_chunks FOR DELETE TO authenticated USING (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.is_org_member(organization_id, auth.uid())
END);


--
-- TOC entry 4308 (class 3256 OID 41792)
-- Name: knowledge_chunks knowledge_chunks_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_chunks_insert ON public.knowledge_chunks FOR INSERT TO authenticated WITH CHECK (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.is_org_member(organization_id, auth.uid())
END);
...
--
-- TOC entry 4307 (class 3256 OID 41791)
-- Name: knowledge_chunks knowledge_chunks_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_chunks_select ON public.knowledge_chunks FOR SELECT TO authenticated USING (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
...
--
-- TOC entry 4309 (class 3256 OID 41793)
-- Name: knowledge_chunks knowledge_chunks_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_chunks_update ON public.knowledge_chunks FOR UPDATE TO authenticated USING (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.is_org_member(organization_id, auth.uid())
END) WITH CHECK (
...
--
-- TOC entry 4264 (class 0 OID 18067)
-- Dependencies: 371
...
--
-- TOC entry 4306 (class 3256 OID 41790)
-- Name: knowledge_documents knowledge_documents_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_documents_delete ON public.knowledge_documents FOR DELETE TO authenticated USING (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.is_org_member(organization_id, auth.uid())
END);
...
--
-- TOC entry 4304 (class 3256 OID 41788)
-- Name: knowledge_documents knowledge_documents_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_documents_insert ON public.knowledge_documents FOR INSERT TO authenticated WITH CHECK (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.is_org_member(organization_id, auth.uid())
END);
...
--
-- TOC entry 4303 (class 3256 OID 41787)
-- Name: knowledge_documents knowledge_documents_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_documents_select ON public.knowledge_documents FOR SELECT TO authenticated USING (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.can_read_org(organization_id, auth.uid())
END);
...
--
-- TOC entry 4305 (class 3256 OID 41789)
-- Name: knowledge_documents knowledge_documents_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_documents_update ON public.knowledge_documents FOR UPDATE TO authenticated USING (
CASE
    WHEN (scope = 'conversation'::text) THEN public.is_conversation_participant(conversation_id, auth.uid())
    ELSE public.is_org_member(organization_id, auth.uid())
END) WITH CHECK (
...
--
-- TOC entry 4270 (class 0 OID 18488)
-- Dependencies: 377
...
--
-- TOC entry 4302 (class 3256 OID 41786)
-- Name: knowledge_spaces knowledge_spaces_delete_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_spaces_delete_org ON public.knowledge_spaces FOR DELETE TO authenticated USING (public.is_org_member(organization_id, auth.uid()));


--
-- TOC entry 4300 (class 3256 OID 41784)
-- Name: knowledge_spaces knowledge_spaces_insert_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_spaces_insert_org ON public.knowledge_spaces FOR INSERT TO authenticated WITH CHECK (public.is_org_member(organization_id, auth.uid()));


--
-- TOC entry 4299 (class 3256 OID 41783)
-- Name: knowledge_spaces knowledge_spaces_select_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_spaces_select_org ON public.knowledge_spaces FOR SELECT TO authenticated USING (public.can_read_org(organization_id, auth.uid()));


--
-- TOC entry 4301 (class 3256 OID 41785)
-- Name: knowledge_spaces knowledge_spaces_update_org; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY knowledge_spaces_update_org ON public.knowledge_spaces FOR UPDATE TO authenticated USING (public.is_org_member(organization_id, auth.uid())) WITH CHECK (public.is_org_member(organization_id, auth.uid()));


--
-- TOC entry 4262 (class 0 OID 17615)
-- Dependencies: 369
...
--
-- TOC entry 4313 (class 3256 OID 41798)
-- Name: message_attachments message_attachments_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY message_attachments_insert ON public.message_attachments FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.messages m
  WHERE ((m.id = message_attachments.message_id) AND public.is_conversation_participant(m.conversation_id, auth.uid())))));


--
-- TOC entry 4312 (class 3256 OID 41797)
-- Name: message_attachments message_attachments_select; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 4261 (class 0 OID 17600)
-- Dependencies: 368
...
--
-- TOC entry 4278 (class 3256 OID 17657)
...
--
-- TOC entry 4277 (class 3256 OID 17656)
...
--
-- TOC entry 4267 (class 0 OID 18187)
-- Dependencies: 374
...
--
-- TOC entry 4266 (class 0 OID 18178)
-- Dependencies: 373
...
--
-- TOC entry 4258 (class 0 OID 17555)
-- Dependencies: 365
...
--
-- TOC entry 4272 (class 3256 OID 17649)
...
--
-- TOC entry 4271 (class 3256 OID 17648)
...
--
-- TOC entry 4273 (class 3256 OID 17650)
...
-- Dependencies: 619
-- Name: FUNCTION can_read_org(p_organization_id uuid, p_user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.can_read_org(p_organization_id uuid, p_user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.can_read_org(p_organization_id uuid, p_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.can_read_org(p_organization_id uuid, p_user_id uuid) TO service_role;
...
-- Dependencies: 618
-- Name: FUNCTION is_system_org(p_organization_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.is_system_org(p_organization_id uuid) TO anon;
GRANT ALL ON FUNCTION public.is_system_org(p_organization_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.is_system_org(p_organization_id uuid) TO service_role;
...
--
-- TOC entry 2695 (class 826 OID 16494)
...
--
-- TOC entry 2696 (class 826 OID 16495)
...
--
-- TOC entry 2694 (class 826 OID 16493)
...
--
-- TOC entry 2698 (class 826 OID 16497)
...
--
-- TOC entry 2693 (class 826 OID 16492)
...
--
-- TOC entry 2697 (class 826 OID 16496)
...
-- Completed on 2026-07-16 16:50:39
